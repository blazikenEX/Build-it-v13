...
def chatbot_responses(user_input):
  ...
  if "campus map" in user_input:
    return "I recommend checking out the aalto usefuk map for movie recommendations. They have a wide variety of genres and ratings to choose from."
